...
///
/// [중복 코드를 줄이는 방법]
/// 골드·젬·경험치는 "얼마를 줄지 계산하는 방식"이 완전히 같고
/// "어디에 주는지"만 다릅니다.
...
/// <summary>골드 지급.</summary>
[CreateAssetMenu(menuName = "Game/Augment/골드 지급", fileName = "Augment_Gold")]
...
/// <summary>젬 지급. 고급 재화이므로 scaleWithStage 는 보통 꺼둡니다.</summary>
[CreateAssetMenu(menuName = "Game/Augment/젬 지급", fileName = "Augment_Gem")]
...
/// <summary>경험치 지급.</summary>
[CreateAssetMenu(menuName = "Game/Augment/경험치 지급", fileName = "Augment_Exp")]
